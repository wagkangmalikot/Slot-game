...
interface JQuery {
    ...
    */
    ...
    /**
     * Steve added code here
     */
    datepicker(config: any): JQuery;
    datepicker(method: string, data?: any): string;
}
...
declare interface TweenLiteStatic{
    to( target:any, duration:number, des:any ): TweenLiteObject;
    fromTo( target:any, duration:number, src:any , des:any ): TweenLiteObject;
}

declare interface TweenLiteObject{
    kill();
}

declare interface momentStatic {    
    (date:Date): momentStatic;
    format( format:string ): string;
}


declare var moment: momentStatic;
declare var TweenLite: TweenLiteStatic;